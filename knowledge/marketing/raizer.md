...
- Assembly: 4 identical legs and 2 identical backrests (impossible to assemble incorrectly), intuitive sound/LED indicators confirm correct assembly; end stop ensures correct positioning for use and disassembly; carry bag included
- Number of lifts on full charge: 40 at max load, ~80 at average load
- Charging: up to 6 hours for full charge; 10–15 minutes minimum charge = 1 lift; USB charger and 15W standard-socket charger both supplied
- Remote control: up/down buttons + battery indicator, embeds into the side of the seat when not in use (emits a warning if not returned)
- Emergency stop button on side of seat; service-reminder indicator; battery-level indicator (5 bars)
- Seatbelt independently adjustable on the backrest for upper-body stability; removable for washing
- Cleaning: all surfaces designed for easy cleaning, and the chair may be disinfected
- Compliance: AS/NZS 4268; ISO 9001:2015
- Warranty: 1 year
...
4. Ensure head/neck support, arms across chest, then press the up-button on the seat or remote to lift; releasing the button immediately stops the lift
5. Stop when the patient is upright with feet flat on the floor, or complete the full lift until an audible beep sounds
6. Device auto-powers off after 10 minutes of no use. **The emergency stop button must be released before the device can be used.**

## Product codes
| Code | Item |
|---|---|
| MHLU-105029 | Raizer II Lifting Chair (incl. remote control, carry case, seat cover, 15W battery charger, USB charger, packing) |
| MHLU-107464 | Head Rest accessory |
| MHLU-107273 | Raizer II Trolley |
| MHLU-107250 | Seatbelt |
