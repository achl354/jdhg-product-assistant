# Hygenica — Disposable IPC Curtains & Blinds
...
- Tested against bovine coronavirus (SARS-CoV-2 reference strain) with a log 3.63 reduction in 15 minutes contact time (per Dr. Brill + Partner GmbH testing)
- Protection is claimed to last the lifespan of the curtain (not just at time of manufacture)
...
- Hook types: **UniFit** (fits existing hook-and-runner systems) and **EasyFit** (fits directly into existing tracks, low-resistance glide)
- Standard drop 2m (mesh version 2.5m); sizes: Small (2.4–2.5m wide), Standard (4.5m wide), Large (7.35–7.5m wide)
- Available in 7 colours: White, Grey, Light Blue, Cream, Lilac, Medical Green, Medical Blue (colour availability varies by hook type/size — see product code tables)
- Usage/care: recommended hanging up to 12 months in normal-risk areas (outpatients, maternity), reduced in high-risk areas (ICU, A&E); replace if visibly soiled/stained; do not launder or apply cleaning agents; light lubrication of tracking every 4–6 weeks recommended; store boxed, out of direct sunlight, 10–40°C, <80% humidity

### Curtain product codes
...
- Flame retardant to NHS standard BS 5867 Part 2 Type C 2008
- Compliant with EN13120 (2014) child-safety/anti-ligature legislation for internal blinds — required for wards where children under 42 months are present or have access
- Custom-made to fit any window; roller blind product codes follow `ICCI-RB-<size code>` (e.g. `ICCI-RB-A1` = width 0–1250mm, drop 0–1250mm) — see the Roller Blind Ordering Details flyer for the full width/drop matrix and the Roller Blind Order Form for the order template
