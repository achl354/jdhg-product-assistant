  ...
  input_schema: {
    ...
    properties: {
      ...
      customer_ready: {
        type: "string",
        description:
          "A customer-safe, humanized message a rep could paste directly into an email or chat — natural prose in full sentences/paragraphs (no headers, no bold emphasis), with no source mentioned inline. A short bulleted list ('- item') is fine for genuinely discrete steps/items, but shouldn't be the whole message. End with the source on its own final line, separated by a blank line, formatted exactly as 'Reference: <document name>' — never woven into the message body itself. No internal hedging/caveat language. " +
