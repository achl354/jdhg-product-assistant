  ...
  input_schema: {
    ...
    properties: {
      ...
      customer_ready: {
        type: "string",
        description:
          "A customer-safe, humanized paragraph a rep could paste directly into an email or chat message — natural prose, no markdown symbols, no internal hedging/caveat language, with one light natural mention of the source (e.g. 'per the manufacturer's care guide...'). " +
