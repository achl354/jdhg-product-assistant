  ...
  input_schema: {
    ...
    properties: {
      ...
      customer_ready: {
        type: "string",
        description:
          "A customer-safe, humanized message a rep could paste directly into an email or chat — natural prose in full sentences/paragraphs (no headers, no bold emphasis), with one light natural mention of the source (e.g. 'per the manufacturer's care guide...'). A short bulleted list ('- item') is fine for genuinely discrete steps/items, but shouldn't be the whole message. No internal hedging/caveat language. " +
